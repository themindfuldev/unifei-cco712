 ...
 */
public class VirolaReta extends Figura
{
	// Atributos
	/**
	 * Ponto central
	...
	// Construtores
	public VirolaReta(Ponto centro, int quantidadeArcosSuperior,
	...
	public VirolaReta(Ponto centro, VirolaReta modelo)
	{
	...
	private void constroiVirola()
	{
		...
		if (quantidadeArcosSuperior == 1)
		{
			...
			/** *************************************************************************** */
			listaFormasPlotaveis.add(new Segmento(pInicioArco, pFimArco));
		}
		/** *************************************************************************** */
		...
		else if (quantidadeArcosSuperior == 2)
		{
			...
			pIntersecaoArcos = Operacoes.intersecaoArcos(circuloEsquerdo,
					circuloDireito, true);
			listaFormasPlotaveis.add(new Segmento(pInicioArco, pIntersecaoArcos));
			listaFormasPlotaveis.add(new Segmento(pIntersecaoArcos, pFimArco));
		}
		...
		listaFormasPlotaveis.add(new Segmento(new Ponto(xCentro, yCentro-altura/2), new Ponto (xCentro, yCentro+altura/2)));
