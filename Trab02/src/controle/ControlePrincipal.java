...
public class ControlePrincipal
{
	...
	// Atributos
	/**
	 * Cor a serem pintados os novos segmentos a serem criados.
	 */
	private Color cor;	
	/**
	 * Tabela de cores.
	...
	// Construtor
	public ControlePrincipal(Color cor)
	{
		this.cor = cor;
   ...
   public void lerArquivo(File arquivo) throws IOException, FileNotFoundException, EOFException, Exception
	{
		...
		SegmentoInputStream stream = new SegmentoInputStream(
				new FileInputStream(arquivo), cor);
	...
	public void mudarCor(Color cor)
	{
		...
		// Percorre a lista de segmentos e altera a cor de cada um.
		for (Segmento segmento: listaSegmentos)
			segmento.mudarCor(cor);
	}
