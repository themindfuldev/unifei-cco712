...
public class JanelaPrincipal extends JFrame implements ActionListener
{
	...
	public JanelaPrincipal(ControlePrincipal controle)
	{
		...
		super("Trabalho 3: Plotando retas com DDA inteiro");
	...
	public void actionPerformed(ActionEvent evento)
	{
		...
		{
			JOptionPane.showMessageDialog(this, "Trabalho de CCO712 - Computação Gráfica I\n\nHeron Yugo Inouye - 11877\nTiago Romero Garcia - 12643", "Créditos",
	...
	private void opcCarregar()
	{
		...
		if (returnVal == JFileChooser.APPROVE_OPTION)
		{
			...
			{
				JOptionPane.showMessageDialog(this, "Erro na abertura do arquivo!", "Erro",
						JOptionPane.ERROR_MESSAGE);
			}
		}
	}
